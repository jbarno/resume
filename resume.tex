...
Participated in large scale cutover of market operations to baremetal servers.
...
Primarily responsible for automating patching of all kernel and OS-level packages worldwide on baremetal VMWare virtual and physical Linux infrastructure.
...
Utilized baremetal infrastructure to automatically test new externally written code.
