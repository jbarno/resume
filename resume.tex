...
\begin{list1}
\item [] Professional with experience in software development, test automation, system administration, security hardening, compliance standards, and team leadership. As an autodidact, I have greatly enjoyed working in a variety of industries including video streaming, ecommerce, genomics, contract life-cycle management, real-estate, biological research, aviation logistics, and medical devices. I excel when difficult problems are put before me, and truly shine within a collaborative work environment.
\end{list1}
...
\item [] {\em TEKSystems Contractor on Abbott Artificial Intelligence as a Service Team} \hfill {\bf 2024 - current}\\
...
Safely and successfully migrated CICD pipelines to cloud native infrastructure.
Enabled deployments of both Linux and Windows Virtual Machines to on-prem Nutanix hosts.
Enabled deployments of Azure AI Services in an enterprise environment.
Reduced unit test execution time while increasing code covererage via trimming database migrations and enabling parallelization.
Identified numerous opportunities for feature enhancements and cost reductions within cloud infrastructure.\\

Learned how small changes can have profound changes to large organizations\\
...
Deployed monitoring solution on Kubernetes able to see all drones and detect and avoid aerial collisions worldwide.
...
Learned how to deal with high stress situations, in a remote environment.\\

\item [] {\bf Neighborhoods.com} \hfill \textit{Chicago, IL}
\item [] {\em DevOps and Enterprise Services Manager} \hfill {\bf 2020 - 2022}\\
Hired as a DevOps engineer to maintain and extend existing real-estate data infrastructure.
...
Developed reusable self monitoring infrastructure as code for deploying Postgres clusters on AWS RDS.
...
Worked with numerous subject matter experts to learn how to rectify various failure modes.
...
Led a team of three FTEs and four UChicago interns.
Reviewed countless lines of code across multiple disciplines: bioinformatics, infrastructure, data migrations, and the application layer.
