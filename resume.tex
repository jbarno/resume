...
\begin{list1}
\item [] Highly motivated and results-oriented professional with experience in software development, test automation, system administration and hardening, and team leadership. Seeking immediate hybrid or on site employment with the U.S.
\end{list1}
...
Deployed monitoring solution able to see all drones and detect and avoid targets worldwide on Kubernetes.
...
Learned how to deal with high stress situations, and 100\% remote work does not meet my requirements for collaboration.\\
...
Deployed machine learning models to make business decisions, to free up human resources.
...
Configured PagerDuty alerts to alert teammates of issues, including silencing/queuing of non-critical alerts during off-hours.
...
Handled hiring and managing one FTE System Administrator employee, and one contract DevOps employee.\\
...
Primarily responsible for automating patching all kernel and OS-level packages worldwide on on-prem VMWare virtual and physical Linux infrastructure.
...
Promoted to QA Lead within a year.
...
Learned how to align others' personal goals with that of the organization, and gained extensive knowledge of Openstack virtualization and Saltstack configuration.\\
...
Studied the demographic breakdown of those changes and made additional changes to adjust to our largest markets.\\
...
Learned how to motivate a team, prioritize work, Agile work processes, and how to put out a technical fire.\\

\item [] {\bf Microsoft Mediaroom} \hfill \textit{Mountain View, CA}
\item [] {\em SDET Intern} \hfill {\bf 2013 - 2013}\\
During three month internship with the Test Tools and Infrastructure team I adapted email templates to speed up developer diagnosis of failing test cases.
