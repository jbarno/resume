...
\begin{list2}
\item  Led the hiring process for multiple open positions during a global pandemic.
...
\item  Developed reusuable infrastructure as code with terraform for deploying postgres clusters on AWS RDS.
\end{list2}
